...
int funcn_lin(double a, const double G[], double F[], void *params)
{
  ...
  //ZW's edit starts
	double mu1 = mu(a,p.kv[0],p.omega0, omegacb, p.extpars,p.model);
  //ZW's edit ends
	/* 1st order */
	//1. F1/G1(k)
	F[0] = -G[1]/a;
...
int funcn1(double a, const double G[], double F[], void *params)
{
  ...
  // ZW's edit starts
	...
	mu1 = mu(a,p.kv[0],p.omega0, omegacb, p.extpars,p.model);
	mu2 = mu(a,p.kv[1],p.omega0, omegacb, p.extpars,p.model);
	mu3 = mu(a,p.args[0],p.omega0, omegacb, p.extpars,p.model);
	mu4 = mu(a,p.args[3],p.omega0, omegacb, p.extpars,p.model);
    // ZW's edit starts
...
int func(double a, const double G[], double F[], void *params)
{
  ...
  //ZW
	double mu0;
	mu0 = mu(a,0.0001,p.omega0,p.omega0 - p.omeganu, p.extpars,p.model); //k->0 limit
  //ZW
